...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="slanman"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/h3/w7frw_vd6ls7qqc4mvq18_880000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/spencer/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/spencer/.mailcheckrc"
# }
